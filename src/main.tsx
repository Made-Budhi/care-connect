        ...
        children: [
            {
                ...
                children: [
                    ...
                    {
                        path: "/sponsor/funding/view/:uuid",
                        element: <FundingSubmissionDetail mode={"view"} breadcrumbs={[
        ...
        children: [
            {
                ...
                children: [
                    ...
                    {
                        path: "/school/children/achievements/:achievementUuid/edit",
                        element: <AddEditAchievement mode={"edit"}/>
                    },
